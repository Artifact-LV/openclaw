  ...
  return raw
    .map(({ page, claim, input }) => {
      ...
      return {
        ...
        ...(reconciled.source_path ? { source_path: reconciled.source_path } : {}),
        ...(reconciled.source_repo ? { source_repo: reconciled.source_repo } : {}),
        ...(reconciled.source_commit ? { source_commit: reconciled.source_commit } : {}),
        ...
        ...(typeof reconciled.confidence === "number" ? { confidence: reconciled.confidence } : {}),
        ...(page.id ? { page_id: page.id, pageId: page.id } : {}),
